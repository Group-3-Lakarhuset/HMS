...
namespace HMS.Migrations
{
    ...
    [Migration("20251128050733_AddedLeaves")]
    partial class AddedLeaves
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HMS.Models.Leave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HMS.Models.LeaveBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("ParentalDaysUsed")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("SickDaysUsed")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("StaffId")
                        .HasColumnType("int");

                    b.Property<decimal>("VABDaysUsed")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("VacationDaysRemaining")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("VacationDaysTotal")
                        .HasColumnType("int");

                    b.Property<decimal>("VacationDaysUsed")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HMS.Models.Leave", b =>
                {
                    b.HasOne("HMS.Data.ApplicationUser", "ApproverUser")
                        .WithMany()
