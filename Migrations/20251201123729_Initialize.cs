        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VacationDaysUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VacationDaysRemaining = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SickDaysUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    VABDaysUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ParentalDaysUsed = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveBalances_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leaves_AspNetUsers_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LateArrivalMinutes = table.Column<int>(type: "int", nullable: true),
                    EarlyDepartureMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveBalances_StaffId_Year",
                table: "LeaveBalances",
                columns: new[] { "StaffId", "Year" },
                unique: true);
